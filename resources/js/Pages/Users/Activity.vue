  ...
  <AuthenticatedLayout>
    <main class="mt-[-20px] mb-14">
                  ...
                  <div class="flex items-center gap-2 px-2">
                    ...
                    <div class="flex flex-col">
                      <h3 class="text-[12px] flex flex-wrap items-center gap-x-2 font-bold text-gray-700"
                        ...
                        <Link :href="route('myActivity', el.user_id)" class="text-[12px]">{{ el.creator_name }}</Link>
      ...
      <div v-else class="bg-white mt-3 flex flex-col gap-y-4 items-center py-8">
        ...
        <p class="basis-full text-[12px] font-bold text-gray-700" v-if="$page.props.auth.user.id === users.id">Vous n'avez
          pas de contenu !</p>
